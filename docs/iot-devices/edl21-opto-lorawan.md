...
2. Under Configuration click "Reload Config" and change the fields ReadCron and ObisCode as you need followed by clicking on "Write to Device". [Example Settings](./img/edl21_config_tool.jpg)
